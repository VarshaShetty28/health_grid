    ...
    <div className="max-w-6xl mx-auto py-2 font-sans">
      ...
      <div className="flex flex-col md:flex-row gap-10 mb-20">
        ...
        <div className="md:w-2/5 lg:w-3/5 flex justify-center items-center">
          <div className="rounded-lg overflow-hidden shadow-lg w-90 h-80">
            <img 
              src={contactUs} 
    ...
    <div className="space-y-6">
      ...
      {/* <div className="mb-16">
          <div className="w-full h-80 rounded-xl shadow-md overflow-hidden">
            <iframe
              title="Health Grid Headquarters Map"
              src="https://www.google.com/maps?q=123+Health+Avenue,+San+Francisco,+CA+94103&output=embed"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
