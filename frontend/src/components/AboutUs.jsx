...
const AboutUs = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 font-sans">
      ...
      <div className="mb-16">
        <h2 className="text-2xl font-bold mb-8">WHY <span className="text-blue-600">CHOOSE US</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="border rounded-lg p-6 hover:shadow-lg transition-shadow">
            <div className="mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">EFFICIENCY:</h3>
            </div>
          ...
          <div className="border rounded-lg p-6 hover:shadow-lg transition-shadow">
            <div className="mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">PERSONALIZATION:</h3>
            </div>
            <p className="text-gray-700">
      ...
      {/* Team Section */}
      <div>
  <h2 className="text-2xl font-bold mb-8">OUR <span className="text-blue-600">TEAM</span></h2>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div className="text-center">
      ...
      <a href="mailto:sarah.johnson@example.com" className="text-blue-600 hover:underline">Email Dr. Sarah</a>
    </div>
    ...
    <div className="text-center">
      ...
      <a href="mailto:michael.chen@example.com" className="text-blue-600 hover:underline">Email Michael</a>
    </div>
    ...
    <div className="text-center">
      ...
      <p className="text-gray-600">Patient Experience Director</p>
      <a href="mailto:emma.rodriguez@example.com" className="text-blue-600 hover:underline">Email Emma</a>
    </div>
  </div>
</div>
